...
intros.
assert (eF b g i a a i f d) by applying (axiom_cutoff1 b g c i a a i c f d) (* from steps: 4, 5, 5, 3, 7, 0 *).
assert (eF g b e i f d h i) by applying (axiom_cutoff2 g b e a i f d h a i) (* from steps: 2, 1, 6, 8 *).
assert (eF i g b e d f i h) by applying (axiom_EFsymmetricsat56sat60sat318sat330sat386 g b e i f d h i) (* from steps: 9 *).
conclude.
Qed.
