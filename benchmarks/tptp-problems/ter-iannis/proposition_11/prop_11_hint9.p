% ./larus -vcoq -m5 -l40 benchmarks/tptp-problems/ter-iannis/proposition_11/prop_11_hint9.p
...
fof(proposition_11,conjecture,(! [A,B,C] : (? [E,F] : ((betS(A,C,B)) => (betS(A,C,E) & equilateral(A,E,F) & cong(A,F,E,F) & cong(A,C,E,C) & (C != F) ))))).
...
fof(hintname3, hint, _, _, defncollinear(0,2,4)).
