% ./larus -vcoq -m30 -l100 benchmarks/tptp-problems/ter-iannis/proposition_11/prop_11_hint2.p
...
fof(hintname0, (0 != 2), _, _).
fof(hintname1,hint,_, _, lemma_extension(0,2,0,2)).
fof(hintname2,hint,triangle(0,3,?) & equilateral(0,3,?), _, proposition_01(0,3)).
fof(hintname3,hint,cong(2,0,?,2), 21, lemma_doublereverse(?,?,?,?)).