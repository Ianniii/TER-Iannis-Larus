% ./larus -vcoq -m5 -l40 benchmarks/tptp-problems/ter-iannis/proposition_11/prop_11_hint8_3.p
% cat proofs/PROOFprop_11_hint8_3pQF_BVmin.v
% cat proofs/PROOFprop_11_hint8_3pQF_BV.v

%%% Without hint
% -i  : Size 5 Time 0.2s
% Without -i : Size 5 Time 4.5s

%%% With hint
% -i : Size 5 Time 0.2s
% Without -i : Size 5 Time 1s
...
%fof(hintname0, hint, _, _, defncollinear(0,2,4)).
