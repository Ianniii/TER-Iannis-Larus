...
fof(lemma_twoperpsparallel,conjecture,(! [A,B,C,D] : (?[E] : ((per(A,B,C) & per(B,C,D) & oS(A,D,B,C)) => (betS(B,C,E) & per(D,C,E) & out(C,D,D)))))).
...
fof(hintname3, hint, _, _, lemma_rightangleNC(1,2,3)).
