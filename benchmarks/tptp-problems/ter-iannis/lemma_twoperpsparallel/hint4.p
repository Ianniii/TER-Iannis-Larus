%%% ./larus -vcoq -m10 -l50 benchmarks/tptp-problems/ter-iannis/lemma_twoperpsparallel/hint2.p
% -m12
% Without hintname2 :
% Time 89s Size 12 (6)
% With hintname2 :
...
fof(lemma_twoperpsparallel,conjecture,(! [A,B,C,D] : (?[E] : ((per(A,B,C) & per(B,C,D) & oS(A,D,B,C)) => (rT(D,B,C,B,C,D)))))).
...
fof(hintname5, hint, _, _, lemma_Euclid4(0,1,2,1,2,3)).
fof(hintname6, hint, _, _, lemma_Euclid4(1,2,3,3,2,?)).
fof(hintname3, hint, _, _, deftworightangles2(0,1,2,1,2,3,1,2,?,3,3)).
